...
<div id="wrap">
    ...
    <div id="meta"><b class="rc-tp"><b></b></b>
        ...
        <{/foreach}>
        <li class="bd">
            <strong><a href="<{$URL_HTML}>/local/">地方服务</a></strong>
            ...
            <a  href="<{$URL_HTML}>/local/taiwan.htm" title="台湾">台湾</a>
            <a  href="<{$URL_HTML}>/local/aomen.htm" title="澳门">澳门</a>
            <a  href="<{$URL_HTML}>/local/hongkong.htm" title="香港">香港</a>

            <span class="more"><a href="<{$URL_HTML}>/local/">更多 &raquo;</a></span>
        </li>
         <{if $links}>
         <li class="bd">
    ...
    <div id="fs">
        ...
        <b class="rc-bt"><b></b></b></div>
    <div id="footer">
        <div class="link"><a href="http://www.114la.com/114la/">关于114啦建站系统V1.14</a> | <a href="<{$URL}>/url-submit/">网站提交</a> | <a href="<{$URL}>/feedback">意见反馈</a> | <a href="http://www.114la.com/114la/">源码下载</a><br />
        </div>
        <div class="hr"></div>
